...
Если пользователь не разрешен, Mini App показывает экран `Доступ не выдан`, его Telegram ID и кнопку отправки заявки. Заявка приходит админам в Telegram с кнопкой `Разрешить пользователя`.
